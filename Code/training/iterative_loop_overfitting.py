...
current_model_name = 'refipsai/MMO1'

# Instead of using append, collect all rows and concatenate them at the end
rows = []

for i in tqdm(range(1, 2), desc="Processing iterations"):  # Start from M3 to M10
    ...
    # Define file paths/kaggle/input/dd-original/DD_original.txt/kaggle/input/dataset-dd/DD.txt'
    input_file_path = f'/kaggle/input/dd-original/DD_original.txt'
    synthetic_output_file_path = f'/kaggle/working/DDO{i}.txt'
    model_output_dir = f'/kaggle/working/MMO{i + 1}'
