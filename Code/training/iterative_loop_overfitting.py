"""
Iterative synthetic fine-tuning loop with the Overfitting mitigation strategy.

Same as the baseline loop, but with:
...
INITIAL_MODEL = "models/MMO1"                   # Overfitting Generation 0 model (or "refipsai/MMO1")
OUTPUT_DIR = "models"
...
def fine_tune_model(train_file_path, output_dir, tokenizer, model):
    """Fine-tune with overfitting hyperparameters (25 epochs, no weight decay)."""
    ...
    training_args = TrainingArguments(
        ...
        num_train_epochs=25,                # 5x baseline
...
for gen in tqdm(range(START_GEN, END_GEN + 1), desc="Generations"):
    ...
    # Step 2: Fine-tune with overfitting hyperparameters
