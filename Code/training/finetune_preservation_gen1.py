# 10 percent fine-tuning to MMK2
...
model_output_dir = f'/kaggle/working/MMP2'
...
def fine_tune_model(synthetic_data_path, original_data_path, output_dir):
    # Load the prepared dataset
    synthetic_data = read_articles_from_text(synthetic_data_path)
    original_data = read_articles_from_text(original_data_path)
    random_subset = original_data.sample(n=152, random_state=43)  # random_state ensures reproducibility
    ...
    combined_file_path = '/kaggle/working/CombinedTrainingDataforMP2.txt'
...
synthetic_output_file_path = f'/kaggle/input/ex5-dd1/DD1.txt'


fine_tune_model(synthetic_output_file_path, input_file_path, model_output_dir)
